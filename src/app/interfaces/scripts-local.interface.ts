...
export const NETWORK = {
    ...
    localdownload1: `echo $local1 | awk '{print $2}'`,
    localdownload2: `echo $local2 | awk '{print $2}'`,
    localdownload: `expr '(' $localdownload2 - $localdownload1 ')'`,
    localupload1: `echo $local1 | awk '{print $10}'`,
    localupload2: `echo $local2 | awk '{print $10}'`,
    localupload: `expr '(' $localupload2 - $localupload1 ')'`,
    localdownpacket1: `echo $local1 | awk '{print $3}'`,
    localdownpacket2: `echo $local2 | awk '{print $3}'`,
    localdownpacket: `expr '(' $localdownpacket2 - $localdownpacket1 ')'`,
    localuppacket1: `echo $local1 | awk '{print $11}'`,
    localuppacket2: `echo $local2 | awk '{print $11}'`,
    localuppacket: `expr '(' $localuppacket2 - $localuppacket1 ')'`,
    wifidownload1: `echo $wifi1 | awk '{print $2}'`,
    wifidownload2: `echo $wifi2 | awk '{print $2}'`,
    wifidownload: `expr '(' $wifidownload2 - $wifidownload1 ')'`,
    wifiupload1: `echo $wifi1 | awk '{print $10}'`,
    wifiupload2: `echo $wifi2 | awk '{print $10}'`,
    wifiupload: `expr '(' $wifiupload2 - $wifiupload1 ')'`,
    wifidownpacket1: `echo $wifi1 | awk '{print $2}'`,
    wifidownpacket2: `echo $wifi2 | awk '{print $2}'`,
    wifidownpacket: `expr '(' $wifidownpacket2 - $wifidownpacket1 ')'`,
    wifiuppacket1: `echo $wifi1 | awk '{print $10}'`,
    wifiuppacket2: `echo $wifi2 | awk '{print $10}'`,
    wifiuppacket: `expr '(' $wifiuppacket2 - $wifiuppacket1 ')'`
};
